...
function $render(opt_data, opt_ignored, opt_ijData) {
  opt_data = opt_data || {};
  var param259 = function() {
    ie_open('div', null, null,
        'class', 'blog');
      $allPosts(opt_data, null, opt_ijData);
    ie_close('div');
  };
  $templateAlias1(soy.$$assignDefaults({content: param259}, opt_data), null, opt_ijData);
}
exports.render = $render;
if (goog.DEBUG) {
...
function $allPosts(opt_data, opt_ignored, opt_ijData) {
  ie_open('div', null, null,
    ...
    ie_open('div', null, null,
        'class', 'container');
      var childIdList278 = opt_data.site.index.children['blog'].childIds;
      var childIdListLen278 = childIdList278.length;
      for (var childIdIndex278 = 0; childIdIndex278 < childIdListLen278; childIdIndex278++) {
        var childIdData278 = childIdList278[childIdIndex278];
        var childPage__soy266 = opt_data.site.index.children['blog'].children[childIdData278];
        ie_open('article', null, null,
            'class', 'post-item container-blog');
          ie_open('a', null, null,
              'class', 'post-item__link',
              'href', childPage__soy266.url);
            ie_open('small');
              itext('By ');
              var dyn21 = childPage__soy266.author;
              if (typeof dyn21 == 'function') dyn21(); else if (dyn21 != null) itext(dyn21);
              itext(' ');
              ie_open('span');
                itext('| ');
                var dyn22 = childPage__soy266.date;
                if (typeof dyn22 == 'function') dyn22(); else if (dyn22 != null) itext(dyn22);
              ie_close('span');
            ie_close('small');
            ie_open('h4', null, null,
                'class', 'post-item__title');
              var dyn23 = childPage__soy266.title;
              if (typeof dyn23 == 'function') dyn23(); else if (dyn23 != null) itext(dyn23);
            ie_close('h4');
            ie_open('p');
              var dyn24 = childPage__soy266.description;
              if (typeof dyn24 == 'function') dyn24(); else if (dyn24 != null) itext(dyn24);
            ie_close('p');
          ie_close('a');
        ie_close('article');
