    ...
    ie_open('div', null, null,
      ...
      for (var childIdIndex277 = 0; childIdIndex277 < childIdListLen277; childIdIndex277++) {
        ...
        ie_open('article', null, null,
          ...
          ie_open('a', null, null,
              'class', 'post-item__link',
              'href', childPage__soy265.url);
            ie_open('small');
              itext('By ');
              var dyn21 = childPage__soy265.author;
              if (typeof dyn21 == 'function') dyn21(); else if (dyn21 != null) itext(dyn21);
              itext(' ');
              ie_open('span');
                itext('| ');
                var dyn22 = childPage__soy265.date;
                if (typeof dyn22 == 'function') dyn22(); else if (dyn22 != null) itext(dyn22);
              ie_close('span');
            ie_close('small');
            ie_open('h4', null, null,
                'class', 'post-item__title');
              var dyn23 = childPage__soy265.title;
              if (typeof dyn23 == 'function') dyn23(); else if (dyn23 != null) itext(dyn23);
            ie_close('h4');
            ie_open('p');
              var dyn24 = childPage__soy265.description;
              if (typeof dyn24 == 'function') dyn24(); else if (dyn24 != null) itext(dyn24);
            ie_close('p');
          ie_close('a');
        ie_close('article');
